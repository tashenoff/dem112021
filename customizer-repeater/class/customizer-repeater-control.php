...
class Customizer_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', get_template_directory_uri().'/customizer-repeater/css/font.css', array(), CUSTOMIZER_REPEATER_VERSION );
		...
		wp_enqueue_script( 'customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/customizer-repeater/js/fontawesome-iconpicker.js', array( 'jquery' ), CUSTOMIZER_REPEATER_VERSION, true );
